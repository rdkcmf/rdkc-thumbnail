...
#define DELIVERY_STN_UPLOAD_INTERVAL                            16
#endif
...
private:
	...
	//initialize and registers Callback for rtmessage
	...
	//On Clip Generation End
	void OnClipGenEnd(const char * cvrClipFname);

	//To Upload STN on clip upload success
	void OnClipUploadSuccess(const char* cvrClipFname);
